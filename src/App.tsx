  ...
  const carros: Carro[] = [
    {
      nome: "Bugatti Chiron",
      imagem:
        "https://www.velhochiconews.com/hf-conteudo/uploads/posts/2024/07/1888_ad0b3997a4a6d2eaf68d6e4882aedead.jpg",
      velocidade: 420,
      potencia: 1500,
      zeroCem: 2.4,
      preco: 15000000,
    ...
    },
    {
      ...
      imagem:
        "https://s2-autoesporte.glbimg.com/Js1qPEf5VtrlGK4nVKmzgx283pc=/0x0:1500x981/888x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_cf9d035bf26b4646b105bd958f32089d/internal_photos/bs/2023/Z/U/ASKDKOSZKKSWvSX2HdOQ/hennessey-venom-f5-revolution-roadster-high-1.jpg",
      velocidade: 500,
      potencia: 1817,
      zeroCem: 2.6,
      preco: 20000000,
    ...
    },
    {
      nome: "SSC Tuatara",
      imagem:
        "https://hips.hearstapps.com/mtg-prod/65c41ca2ecd098000862804e/ssc-na-tuatara-36.jpg",
      velocidade: 455,
      potencia: 1750,
      zeroCem: 2.5,
      preco: 17000000,
    ...
    },
    {
      ...
      imagem:
        "https://upload.wikimedia.org/wikipedia/commons/1/1e/Ferrari_SF90_Stradale.jpg",
      velocidade: 340,
      potencia: 1000,
      zeroCem: 2.5,
      preco: 7000000,
    ...
    },
    {
      ...
      imagem:
        "https://cdn.motor1.com/images/mgl/Vznj6y/s3/brabus-900-rocket-r.webp",
      velocidade: 330,
      potencia: 650,
      zeroCem: 2.7,
      preco: 1500000,
    ...
    },
    {
      nome: "McLaren P1",
      imagem:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/McLaren_P1_GTR_at_Grand_Basel_2018_03.jpg/1280px-McLaren_P1_GTR_at_Grand_Basel_2018_03.jpg",
      velocidade: 350,
      potencia: 916,
      zeroCem: 2.8,
      preco: 1150000,
    ...
    },
    {
      ...
      imagem:
        "https://www.topgear.com/sites/default/files/brightcove/videos/images/posters/1546304439_5844286552001_5844282300001-vs.jpg",
      velocidade: 402,
      potencia: 1160,
      zeroCem: 2.5,
      preco: 15000000,
    ...
    },
    {
      nome: "Pagani Huayra",
      imagem:
        "https://cdn.rmsothebys.com/3/e/7/6/3/e/3e763ed063de7afbb4a632d300174dc235879abb.webp",
      velocidade: 383,
      potencia: 730,
      zeroCem: 3.0,
      preco: 14000000,
